...
var RedeSocial = /** @class */ (function () {
    ...
    RedeSocial.prototype.listarPublicacoes = function () {
        ...
        publicacoesOrdenadas.forEach(function (pub) {
            console.log(ID, $, { pub: pub, : .getId() }, Usuário, $, { pub: pub, : .getUsuario().getApelido() }, Data, $, { pub: pub, : .getDataHora() }, Conteúdo, $, { pub: pub, : .getConteudo() });
            if (pub instanceof PublicacaoAvancada) {
                console.log(Reações, $, { pub: pub, : .getInteracoes().length });
            }
        });
    };
    ...
    RedeSocial.prototype.listarPublicacoesPorUsuario = function (email) {
        ...
        publicacoesOrdenadas.forEach(function (pub) {
            console.log(ID, $, { pub: pub, : .getId() }, Data, $, { pub: pub, : .getDataHora() }, Conteúdo, $, { pub: pub, : .getConteudo() });
        });
    };
