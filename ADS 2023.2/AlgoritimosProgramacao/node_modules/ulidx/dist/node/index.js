...
function detectPRNG(root) {
    ...
    if (typeof globalCrypto !== "undefined" && typeof globalCrypto.getRandomValues === "function") {
        return () => {
    ...
    else if (typeof globalCrypto !== "undefined" && typeof globalCrypto.randomBytes === "function") {
...
export { MAX_ULID, MIN_ULID, decodeTime, detectPRNG, encodeTime, fixULIDBase32, isValid, monotonicFactory, ulid };
