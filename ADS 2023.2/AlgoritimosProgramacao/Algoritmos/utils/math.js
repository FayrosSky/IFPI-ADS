...
export function is_prime(number){
  ...
  return count_dividers === 2 //vai retornar true ou false... nesse caso vai retornar true quando a quantidade for igual a dois.

}


export const is_even = number => number % 2 === 0 //argumento é number e o corpo e o return o number => number % 2 === 0
