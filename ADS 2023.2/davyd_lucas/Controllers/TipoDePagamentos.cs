...
{
    public class TipoDePagamentos : Controller
    {
        private readonly MyDbContext _context;

        public TipoDePagamentos(MyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeDoCobrado,InformacoesAdicionais,Discriminator")] TipoDePagamento tipoDePagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeDoCobrado,InformacoesAdicionais,Discriminator")] TipoDePagamento tipoDePagamento)
        {
